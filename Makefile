...
all: $(SPARSEDIVERS) figures/suppfig-consistency.pdf figures/figure2-hclust-shrinkage.png figures/figure3-big-cluster.pdf 
...
figures/figure3-big-cluster.pdf : R/figure3-cluster.R $(.DEPENDS) $(OBSDATA)
	Rscript $< > $(<)out 2>&1
